...
const items = [
  { href: "/admin/analytics/", title: "アクセス分析", description: "GA4イベント、主要KPI、振り返りメモを管理します。" },
  { href: "/admin/blog/", title: "ブログ管理", description: "公開記事と下書き、Markdown出力、自動投稿案を管理します。" },
  { href: "/admin/sns/", title: "SNSコンテンツ生成", description: "Instagram向けスライド、キャプション、投稿準備を作成します。" },
];
    ...
    <main className="min-h-screen bg-[#f5f0e8] px-5 py-8 text-[#20241f]">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mt-5 border-b border-[#d7cabc] pb-6">
          ...
          <p className="mt-3 max-w-2xl leading-7 text-[#5e625c]">ブログ、アクセス分析、SNS投稿準備をまとめて確認する運用画面です。</p>
        </header>
