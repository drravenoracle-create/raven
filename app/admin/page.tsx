...
const items = [
  { href: "/official-admin/sites/", title: "Official Site Directory", label: "公式サイト一覧", description: "公式運用アカウントでギルドメンバーの公開サイト導線を確認します。" },
