  ...
  return (
    <main className="min-h-screen bg-[#f5f0e8] px-5 py-8 text-[#20241f]">
      <div className="mx-auto max-w-3xl">
        <Link className="text-sm font-semibold text-[#596d51]" href="/">Raven Blackwood</Link>
        <section className="mt-8 rounded border border-[#d7cabc] bg-[#fffaf2] p-6">
          ...
          <p className="mt-3 leading-7 text-[#5e625c]">この管理画面はRaven Blackwoodのオーナー用です。Ravenの管理アカウントでログインしてください。</p>
        </section>
      </div>
    </main>
  );
