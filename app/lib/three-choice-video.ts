...
export function timeline20s() {
  return [
    { id: "theme", start: 0, end: 2, label: "テーマ表示" },
    { id: "choice", start: 2, end: 6, label: "3択選択画面" },
    { id: "result-a", start: 6, end: 10, label: "Aの結果" },
    { id: "result-b", start: 10, end: 14, label: "Bの結果" },
    { id: "result-c", start: 14, end: 18, label: "Cの結果" },
    { id: "cta", start: 18, end: 20, label: "エンディング / CTA" },
  ];
}
