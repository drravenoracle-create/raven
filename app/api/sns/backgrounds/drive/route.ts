...
export async function GET(request: Request) {
  const folderId = new URL(request.url).searchParams.get("folderId") || String((env as unknown as Record<string, unknown>).GOOGLE_DRIVE_VIDEO_FOLDER_ID || "");
