...
test("SNS surfaces consume tenant and character config", async () => {
  ...
  for (const [index, content] of contents.entries()) {
    assert.match(content, /resolveSnsConfig|resolvePilotSnsConfig|resolveRuntimeTenantId|resolveTenantIdFromHost|RAVEN_TENANT_CONFIG|RAVEN_CHARACTER_CONFIG|CHARACTER_CONFIG/,
