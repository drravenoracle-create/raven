...
Atlas and Sol preview configs use `ANALYTICS_DB` pointing to this existing database. Sol uses the shared Core D1; no Sol-specific D1 is required for this preview.
